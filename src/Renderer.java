 ...
 */
public final class Renderer extends Canvas
{
    public static final Renderer DEFAULT_RENDERER = new Renderer(Scene.DEFAULT_SCENE);
    ...
    private void init(final int width, final int height, Scene referenceScene)
    {
    	this.width = width;
    	this.height = height;
    ...
    /**
     * Do not run this, make a PhysicsSimulator instead.
     * @param delta set on a constant tick rate set by PhysicsSmulator as 64. This value should be equal to time / frames.
    ...
    private void drawShapes(ArrayList<SceneObject> sceneObjects)
    {
     ...
     */
    public void render(double delta, double time, long frames)
    {
        updatePixels();
